...
sc = ax1.scatter(cutoff_2_body_flat, cutoff_3_body_flat, cutoff_4_body_flat, c=rmse_score_flat, cmap='viridis')
plt.colorbar(sc, label='RMSE (eV/atom)')
ax1.set_xlabel('2-body cluster cutoff (Å)')
ax1.set_ylabel('3-body cluster cutoff (Å)')
ax1.set_zlabel('4-body cluster cutoff (Å)')
ax1.set_title('RMSE as a Function of Cluster Diameter Cutoff (Å)')

# CV Score plot
ax2 = fig.add_subplot(122, projection='3d')
sc = ax2.scatter(cutoff_2_body_flat, cutoff_3_body_flat, cutoff_4_body_flat, c=cv_score_flat, cmap='plasma')
plt.colorbar(sc, label='CV Score (eV/atom)')
ax2.set_xlabel('2-body cluster cutoff (Å)')
ax2.set_ylabel('3-body cluster cutoff (Å)')
ax2.set_zlabel('4-body cluster cutoff (Å)')
ax2.set_title('CV Score as a Function of Cluster Diameter Cutoff (Å)')
fig.savefig(".././CPSC440-Project/figs/DiameterCutoff.png")

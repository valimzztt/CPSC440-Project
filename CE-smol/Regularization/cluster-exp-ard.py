...
"""
    Scripts that demonstrate a more involved CLUSTER EXPANSION using Automatic Relevance Determination
"""
...
for trial in range(TRIALS):
    ...
    model = ARDRegression(fit_intercept=True) #alpha_1 = alpha_1, alpha_2 = alpha_2, 
...
if (mean_rmse <= np.min(all_rmse)):
    wandb.config.update({"lowest_rmse": mean_rmse}, allow_val_change = True) #, "best alpha_1": alpha_1, "best alpha_2": alpha_2
